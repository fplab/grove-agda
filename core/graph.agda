...
_∪G-elem_ : (Edge × EdgeState) → Graph → Graph
elem ∪G-elem [] = [] 
(e1 , Ge1) ∪G-elem ((e2 , Ge2) ∷ G) with Dec.does (e1 ≟Edge e2)
... | true = (e1 , Ge1 ⊔ Ge2) ∷ ((e1 , Ge1) ∪G-elem G)
... | false = (e1 , Ge1) ∪G-elem G

_∪G_ : Graph → Graph → Graph
[] ∪G G = G
(elem ∷ G₁) ∪G G₂ = G₁ ∪G (elem ∪G-elem G₂)
